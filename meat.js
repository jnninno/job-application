...
// All content placeholders ready for real meat attachment
// ============================================
const MEAT = {
  // ================================================
  // PHASE 1: DESCENT BEGINS (VEIL) - IMPLEMENTED
  // ================================================
...
Have fun! Stay professional! Don't lose yourself!`,
  ...
  '[death.subtitle.corporate]': 'TIME RAN OUT',
  '[death.subtitle.flee]': 'FLED THE INTERVIEW',
  '[death.subtitle.reject]': 'REJECTED THE MAP',
  '[death.corporate]': '[death.corporate.text]',
  '[death.flee]': '[death.flee.text]',
  '[death.reject]': '[death.reject.text]',
  
  // === FOLDERS ===
  '[folder.maps.locked]': '[🗺️ LOCKED]',
  '[folder.maps.open]': '🗺️ Maps',
  '[folder.portfolio.empty]': '[👁️ EMPTY]',
  '[folder.portfolio.open]': '👁️ Portfolio',
  ...
  // VOID (special - 10 single buttons)
...
I still don't fully understand it, but those empty spaces... they might be more important than what we fill them with.`,
  ...
  // ================================================
  // PHASE 3: VOID THRESHOLD - PLACEHOLDERS
  // ================================================
  '[void.name]': 'THE VOID',
...
Without you, there's just a pile of still images. With you, there's a universe in motion.`,
  ...
  '[captain.void.explain]': '[captain.void.explain.text]',
